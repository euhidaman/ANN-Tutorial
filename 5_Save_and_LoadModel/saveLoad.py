...
# Finally, we are saving the Model
...
# Model is loaded, and used in the file `loadModel.py`
# %%
# Method 2 :model.to_json()
...
if os.path.isfile('models/medical_model_weights.h5') is False:
    model.save('models/medical_model_weights.h5')

# Creating model layers, and then adding the saved weights
model2 = Sequential([
    Dense(units=16, input_shape=(1,), activation='relu'),
    Dense(units=32, activation='relu'),
    Dense(units=2, activation='softmax')
